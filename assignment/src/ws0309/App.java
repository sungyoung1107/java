...
//			lotto.makeWinningNumberMoney(); // 당첨번호와 당첨금을 생성한다. //테스트용
			try {
			...
			switch(menu) {	
				case 1: userNum = lotto.getNumUser(); // 입력 받은 숫자 넣어준다.
						...
						lotto.makeWinningNumberMoney(); // 사용자 로또번호 생성 후 당첨번호와 당첨금을 생성
						break;
				case 2: lotto.showNumber(userNum); // 사용자의 숫자를 보여준다.
						break;
				case 3: if(userNum != null) {
							System.out.printf("금번 회차 총 당첨금은 %.0f원 입니다 \n", lotto.getPrizeMoney()); // 전체 당첨금을 보여준다.
						...
						}else System.out.println("== 1번을 눌러 로또번호를 먼저 입력하시기 바랍니다 ==");
						break;
